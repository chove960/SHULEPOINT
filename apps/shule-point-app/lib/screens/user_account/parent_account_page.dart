...
class _ParentAccountPageState extends State<ParentAccountPage> {
  ...
  void setParent() {
    setState(() {
      ...
      if (widget.selectedParent == "Father") {
        parentInfo = studentInfo.parentalInformation.fatherInfo;
      } else {
        parentInfo = studentInfo.parentalInformation.motherInfo;
      }
    });
  }
  ...
  Widget _buildFirstNameField() {
    return Container(
      ...
      child: TextFormField(
        initialValue: getFirstName(parentInfo.fullname),
        readOnly: true,
  ...
  Widget _buildLastNameField() {
    return Container(
      ...
      padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 5),
      child: TextFormField(
        initialValue: getLastName(parentInfo.fullname),
        readOnly: true,
        style: TextStyle(color: custom_theme.secondaryBlue, fontSize: 16),
        maxLines: 1,
        decoration: InputDecoration(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              padding:
                                  const EdgeInsets.only(right: 15, top: 2.5),
